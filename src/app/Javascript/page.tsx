  ...
  const array = [
    {
      ...
      Sample:
        "JavaScript allows developers to create dynamic content, control multimedia, animate images, and much more.",
    ...
    },
    {
      ...
      answer:
        "JavaScript supports several data types, including undefined, null, boolean, string, number, BigInt, and object.",
      Sample:
        "Data types are important for defining what kind of data can be stored and manipulated.",
...
console.log(greet("Alice"));`,
    },
    {
      ...
      answer:
        "The Document Object Model (DOM) is an interface that browsers implement to structure a web document as a tree of objects.",
      Sample:
        "JavaScript can manipulate the DOM to dynamically change the document structure, style, and content.",
    ...
    },
    {
      ...
      answer:
        "Arrays in JavaScript are list-like objects used to store multiple values in a single variable.",
      Sample:
        "Arrays can hold items of any data type and provide various methods for manipulation.",
...
person.greet(); // Output: Hello, John`,
    },
    {
      ...
      answer:
        "A callback function is a function passed as an argument to another function, which is then invoked inside that function.",
      Sample:
...
fetchData((data) => {
    ...
    },
    {
      ...
      answer:
        "let and const are block-scoped variables, while var is function-scoped. const is used for constants that can't be reassigned.",
      Sample:
        "Choosing the right declaration is crucial for maintaining scope and immutability.",
      code: `let x = 10;
const y = 20;
...
// console.log(b); // Error: b is not defined`,
    },
    {
      ...
      answer:
        "'this' refers to the object that is currently executing the function, which can vary based on the context.",
      Sample:
        "Understanding 'this' is key for writing clean and efficient object-oriented JavaScript.",
      code: `const obj = {
    name: "John",
    greet: function() {
        console.log("Hello, " + this.name);
...
obj.greet(); // Output: Hello, John`,
    },
    {
      ...
      Sample:
        "They allow chaining of asynchronous operations and provide better handling of errors.",
...
console.log(0 === '0'); // false`,
    },
    {
      ...
      answer:
        "Event bubbling is a mechanism where events propagate from the target element up to the root of the DOM.",
      Sample:
        "This allows multiple elements to handle the same event without adding listeners to each one.",
...
var x = 5;`,
    },
    {
      ...
      answer:
        "Synchronous programming executes tasks sequentially, while asynchronous programming allows tasks to run concurrently, enabling better performance.",
...
console.log(counter()); // 2`,
    },
    {
      ...
      answer:
        "A 'for' loop executes a block of code a specific number of times, based on an initializer, condition, and increment expression.",
      Sample:
        "It's ideal for iterating when you know the number of iterations beforehand.",
    ...
    },
    {
      ...
      answer:
        "'forEach' is a method that iterates over an array and applies a callback function to each element.",
      Sample:
        "It's useful for applying side effects but doesn't return a new array.",
  ...
  numbers.forEach((num) => {
    ...
    },
    {
      ...
      answer:
        "'for...of' is a loop specifically for iterating over iterable objects like arrays, strings, or NodeLists.",
  ...
  for (const fruit of fruits) {
    ...
    },
    {
      ...
      Sample:
        "It's ideal for object property enumeration, not array iteration.",
  ...
  for (const key in person) {
    ...
    },
    {
      ...
      answer:
        "'if-else' statements conditionally execute code based on whether a condition is true or false.",
      Sample:
        "Useful for decision-making logic in functions or component rendering.",
      code: `const age = 20;
  if (age >= 18) {
    ...
    },
    {
      ...
      answer:
        "The 'switch' statement executes code blocks based on matching cases.",
  ...
  switch (day) {
    ...
    },
    {
      ...
      Sample:
        "It can be used to create copies of arrays or merge multiple arrays.",
...
console.log(merged); // [1, 2, 3, 4, 5, 6]`,
    },
    {
      ...
      answer:
        "Template literals are string literals that allow embedded expressions and multi-line strings, enclosed by backticks (`).",
...
console.log(greeting); // Hello, Alice!`,
    },
    {
      ...
      answer:
        "A module is a reusable piece of code that encapsulates functionality and can be imported/exported between files.",
...
console.log(add(2, 3)); // 5`,
    ...
    },
    {
      ...
      answer:
        "Object.freeze() prevents any changes to an object, while Object.seal() prevents new properties from being added but allows modification of existing properties.",
...
console.log(jsonString); // {"name":"John","age":30}`,
    },
    {
      ...
      answer:
        "Arrow functions are a shorter syntax for writing function expressions and lexically bind the 'this' value.",
...
greetAlice(); // Hello, Alice`,
    },
    {
      ...
      answer:
        "A shallow copy creates a new object but copies properties as references, while a deep copy creates a new object and recursively copies nested objects.",
...
const deepCopy = JSON.parse(JSON.stringify(obj1));`,
    },
    {
      ...
      answer:
        "Local storage is a web storage mechanism that allows storing data as key-value pairs in the browser, accessible even after page refreshes.",
...
console.log(name); // John`,
    },
    {
      ...
      answer:
        "The fetch API is a modern way to make HTTP requests in JavaScript, returning promises.",
    ...
    },
    {
      ...
      answer:
        "Strict mode is a way to opt in to a restricted variant of JavaScript, which helps catch common coding mistakes and 'unsafe' actions.",
      Sample:
        "It can be enabled by adding 'use strict' at the top of a script or function.",
      code: `'use strict';
function myFunction() {
    ...
    },
    {
      ...
      answer:
        "Function declarations are hoisted, while function expressions are not. Declarations can be called before they are defined.",
...
const bar = function() {
    ...
    },
    {
      ...
      answer:
        "The 'finally' block is used to execute code after a promise is settled, regardless of its outcome (fulfilled or rejected).",
...
console.log(operation(5, 3, add)); // 8`,
    },
    {
      ...
      answer:
        "A generator function is a function that can be exited and later re-entered, maintaining its context, allowing you to produce a series of values.",
...
console.log(dog instanceof Animal); // true`,
    },
    {
      ...
      answer:
        "setInterval() is a method that repeatedly executes a function at specified intervals (in milliseconds).",
    ...
    },
    {
      ...
      answer:
        "Both call() and apply() invoke a function with a specified 'this' value, but call() accepts arguments separately, while apply() accepts an array of arguments.",
...
greet.apply(person, ["Hi"]); // Hi, Alice`,
    },
    {
      ...
      Sample:
        "It is useful for aggregating results from multiple asynchronous operations.",
...
console.log(citrus); // ["banana", "cherry"]`,
    },
    {
      ...
      answer:
        "The 'for...of' loop creates a loop iterating over iterable objects, like arrays, strings, or other collections.",
...
for (const number of numbers) {
...

    {
      ...
      answer:
        "The 'reduceRight()' method executes a reducer function on each element of the array, processing from right to left.",
...
console.log(fruits.includes("banana")); // true`,
    },
    {
      ...
      answer:
        "Method chaining is a technique where multiple methods are called on the same object sequentially.",
...
console.log(hasOdd); // true`,
    ...
    },
    {
      ...
      answer:
        "Object.assign() copies values from one or more source objects to a target object, returning the target object.",
...
console.log(getX()); // 42`,
    },
    {
      ...
      answer:
        "window.onload is an event that fires when the whole page (including images, scripts, etc.) is fully loaded.",
...
console.log(evens); // [2, 4]`,
    },
    {
      ...
      answer:
        "localStorage is a web storage mechanism that allows storing data in the browser with no expiration time.",
...
console.log(combined); // [1, 2, 3, 4]`,
    },
    {
      ...
      answer:
        "Async functions allow you to write promise-based code as if it were synchronous, using 'await' to pause execution.",
    ...
    },
    {
      ...
      answer:
        "The 'Math.random()' method returns a floating-point, pseudo-random number in the range 0 to less than 1.",
...
console.log(randomNum); // e.g., 0.123456`,
    },
    {
      ...
      answer:
        "The 'setTimeout()' function calls a function or executes a code snippet after a specified delay (in milliseconds).",

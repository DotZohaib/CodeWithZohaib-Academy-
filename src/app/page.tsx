            ...
            >
              ...
              <div className="flex space-x-4">
                <Link
                  ...
                  className="relative inline-block px-5 py-2 md:px-8 md:py-3 font-semibold bg-pink-700 text-white rounded-lg"
                >
                  ...
                  className="relative inline-block px-5 py-2 md:px-8 md:py-3 font-semibold text-pink-700 border-pink-700 border bg-white rounded-lg"
                >
                  <span className="absolute  top-0 left-0 w-full h-full bg-white opacity-10 rounded-lg"></span>

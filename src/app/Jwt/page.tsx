...
const Jwt: React.FC = () => {
  ...
  const array: Question[] = [
    ...
    },
    {
      ...
      answer:
        "You create a JWT by signing it with a secret key using a library like jsonwebtoken.",
    ...
    },
    {
      ...
      answer:
        "You can verify a JWT using the same secret key that was used to sign it.",
    ...
    },
    {
      ...
      answer:
        "Passport.js is an authentication middleware for Node.js that simplifies the authentication process.",
    ...
    },
    {
      ...
      answer:
        "You set it up by configuring strategies, initializing passport, and setting up session management.",
    ...
    },
    {
      ...
      answer:
        "A strategy is a method of authenticating requests, such as local, JWT, or OAuth strategies.",
    ...
    },
    {
      ...
      answer:
        "Sessions are used to persist user authentication state across requests.",
    ...
    },
    {
      ...
      answer:
        "You handle login by using `passport.authenticate()` in your login route.",
    ...
    },
    {
      ...
      answer:
        "You can protect routes by using `passport.authenticate()` as middleware.",
    ...
    },
    {
      ...
      answer:
        "This method is used to determine which data of the user should be stored in the session.",
    ...
    },
    {
      ...
      answer:
        "This method is used to retrieve the user information based on the ID stored in the session.",
    ...
    },
    {
      ...
      answer:
        "You set up Google authentication by using the Google strategy provided by Passport.js.",
    ...
    },
    {
      ...
      answer:
        "You can store JWT in local storage on the client-side for future requests.",
    ...
    },
    {
      ...
      answer:
        "Token expiration is a security feature that limits the validity of a JWT.",
    ...
    },
    {
      ...
      answer:
        "You can refresh a JWT by issuing a new token when the old one is close to expiration.",
    ...
    },
    {
      ...
      answer:
        "CSRF is an attack that tricks the user into submitting a request that they did not intend.",
    ...
    },
    {
      ...
      answer:
        "You can handle authentication errors by using custom failure redirects.",
    ...
    },
    {
      ...
      answer:
        "You can check if a user is authenticated using `req.isAuthenticated()`.",
    ...
    },
    {
      ...
      answer:
        "You can implement RBAC by checking user roles in your route handlers.",
    ...
    },
    {
      ...
      answer:
        "You can handle token revocation by maintaining a blacklist of revoked tokens.",
    ...
    },
    {
      ...
      answer:
        "Symmetric signing uses a single secret key, while asymmetric signing uses a public/private key pair.",
    ...
    },
    {
      ...
      answer:
        "You can handle JWT expiration by checking the expiration time before making requests.",
    ...
    },
    {
      ...
      answer:
        "Use prepared statements and ORM libraries to prevent SQL injection.",
    ...
    },
    {
      ...
      answer:
        "You can implement registration by hashing passwords and saving user data to the database.",
    ...
    },
    {
      ...
      answer:
        "`req.user` is populated by Passport with the user object, while `req.session.passport.user` holds the user ID.",
    ...
    },
    {
      ...
      answer:
        "You can implement email verification by sending a verification link to the user's email after registration.",
    ...
    },
    {
      ...
      answer:
        "It allows users to stay logged in between sessions by setting a cookie.",
    ...
    },
    {
      ...
      answer:
        "You can implement 2FA by sending a code to the user's mobile device for verification.",
    ...
    },
    {
      ...
      answer:
        "You can redirect users based on their roles after successful login.",
    ...
    },
    {
      ...
      answer:
        "You can implement logout by destroying the session and redirecting the user.",
    ...
    },
    {
      ...
      answer:
        "You can refresh tokens by issuing a new token when the old one is about to expire.",
    ...
    },
    {
      ...
      answer:
        "Environment variables help to manage sensitive data like API keys securely.",
    ...
    },
    {
      ...
      answer:
        "You can implement password reset by generating a token and sending it to the user's email.",
    ...
    },
    {
      ...
      answer:
        "You can protect routes by using middleware to check if a user is authenticated.",
    ...
    },
    {
      ...
      answer:
        "You can implement profile updates by allowing users to edit their information and saving it in the database.",
    ...
    },
    {
      ...
      answer:
        "HTTPS secures data in transit by encrypting communication between the client and server.",
    ...
    },
    {
      ...
      answer:
        "You can handle concurrent requests by using sessions and ensuring the session store is set up correctly.",
    ...
    },
    {
      ...
      answer:
        "You can store tokens in localStorage or sessionStorage on the client side.",
    ...
    },
    {
      ...
      answer:
        "You can set token expiration by including an expiresIn option when signing the token.",
    ...
    },
    {
      ...
      answer:
        "You can validate user input using libraries like Joi or express-validator.",
    ...
    },
    {
      ...
      answer:
        "You can set session expiration by configuring the session store options.",
    ...
    },
    {
      ...
      answer:
        "CSRF tokens protect against Cross-Site Request Forgery by validating requests.",
    ...
    },
    {
      ...
      answer:
        "You can lock accounts by keeping track of failed login attempts.",

...
const Reacte: React.FC = () => {
  ...
  const array: Question[] = [
    ...
    },
    {
      ...
      answer:
        "Components are reusable pieces of UI that can be defined as JavaScript functions or classes.",
    ...
    },
    {
      ...
      Sample:
        "It allows React to calculate the most efficient way to update the UI.",
      code: `const element = <h1>Hello, World!</h1>;
    ...
    },
    {
      ...
      answer:
        "Conditional rendering in React allows you to render different UI elements based on the state or props.",
    ...
    },
    {
      ...
      Sample:
        "Keys should be unique among siblings but can be reused in different parts of the component tree.",
    ...
    },
    {
      ...
      answer:
        "Lifting state up is the process of moving state from a child component to a parent component.",
    ...
    },
    {
      ...
      answer:
        "Uncontrolled components store their own state internally and do not rely on React state.",
    ...
    },
    {
      ...
      answer:
        "Context is a way to pass data through the component tree without props drilling.",
    ...
    },
    {
      ...
      Sample:
        "They are used for cross-cutting concerns like logging or authentication.",
    ...
    },
    {
      ...
      answer:
        "useMemo is a hook that memorizes the result of a calculation between re-renders.",
    ...
    },
    {
      ...
      Sample:
        "It is useful for preventing unnecessary re-renders of child components.",
    ...
    },
    {
      ...
      answer:
        "Functional components are simpler and easier to understand, while class components can manage their own state and lifecycle methods.",
    ...
    },
    {
      ...
      answer:
        "A custom hook is a function that utilizes React hooks to encapsulate logic and can be reused across components.",
    ...
    },
    {
      ...
      answer:
        "useRef is a hook that returns a mutable ref object, which persists for the full lifetime of the component.",
      Sample:
        "It can be used to access DOM elements or to store mutable values.",
    ...
    },
    {
      ...
      answer:
        "PropTypes is a library for type-checking the props of a component.",
    ...
    },
    {
      id: 24,
      Title:
        "24. What is the purpose of the componentDidMount lifecycle method?",
      answer:
        "componentDidMount is called after a component is mounted and can be used for initial data fetching or DOM manipulation.",
    ...
    },
    {
      id: 25,
      Title:
        "25. What is the purpose of the componentDidUpdate lifecycle method?",
      answer:
        "componentDidUpdate is called after updates are made to a component, allowing you to respond to prop or state changes.",
    ...
    },
    {
      id: 26,
      Title:
        "26. What is the purpose of the componentWillUnmount lifecycle method?",
      answer:
        "componentWillUnmount is called before a component is unmounted, allowing for cleanup tasks.",
      Sample:
        "It can be used to remove event listeners or cancel network requests.",
    ...
    },
    {
      ...
      answer:
        "A callback ref is a function that receives the DOM element as its argument, allowing you to perform actions on it.",
    ...
    },
    {
      ...
      answer:
        "Error boundaries are components that catch JavaScript errors in their child component tree, allowing you to handle errors gracefully.",
    ...
    },
    {
      ...
      answer:
        "React Router is a library that enables routing in React applications, allowing for navigation between different components.",
      Sample:
        "It helps in creating single-page applications with multiple views.",
      code: `import { BrowserRouter as Router, Route, Switch } from 'react-router-dom';`,
    },
    {
      id: 30,
      Title:
        "30. What are the differences between controlled and uncontrolled components?",
      answer:
        "Controlled components use React state to manage form data, while uncontrolled components manage their own state.",
      Sample:
        "Controlled components provide better validation and control over the data.",
    ...
    },
    {
      ...
      answer:
        "'forEach' is an array method that iterates over each element in an array, performing a callback function on each item.",
  ...
  const listItems = numbers.map((num) => <li key={num}>{num}</li>);`,
    },
    {
      ...
      answer:
        "'if-else' statements conditionally execute code blocks based on boolean expressions.",
      Sample:
        "'if-else' is essential for controlling flow in JavaScript and React components.",
      code: `const num = 10;
  if (num > 5) {
    ...
    },
    {
      ...
      Sample:
        "It returns an array with the state variable and a function to update it.",
  ...
  const Timer = () => {
    ...
    },
    {
      ...
      answer:
        "Conditional rendering in React shows or hides components based on conditions.",
      Sample:
        "You can use 'if-else', the ternary operator, or logical && for conditional rendering.",
  ...
  return (
    ...
    },
    {
      ...
      Sample:
        "It's useful for iterating over arrays with specific start, stop, and step values.",
    ...
    },
    {
      ...
      answer:
        "'useRef' is a hook for persisting a mutable reference without re-rendering the component.",
      Sample:
        "It's commonly used for DOM manipulation or storing instance values.",
  ...
  const InputFocus = () => {
    ...
    },
    {
      ...
      answer:
        "'map' returns a new array, while 'forEach' executes a function on each array element without returning anything.",
      Sample:
  ...
  numbers.forEach(num => console.log(num * 2)); // Logs: 2, 4, 6`,
    },
    {
      ...
      answer:
        "'useContext' is a React hook that accesses context values within components.",
      Sample:
        "It simplifies passing values through the component tree without props.",
  ...
  const MyComponent = () => {
    ...
    },
    {
      ...
      answer:
        "TypeScript provides static typing, better tooling, and improved code maintainability in React applications.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "Forms in React can be handled with controlled components using state or using libraries like Formik.",
    ...
    },
    {
      ...
      answer:
        "Side effects are operations that can affect other components outside the function component, like data fetching or subscriptions.",
    ...
    },
    {
      ...
      answer:
        "React.StrictMode is a wrapper that helps highlight potential problems in an application during development.",
      Sample:
        "It does not affect the production build but provides warnings for unsafe lifecycle methods and other issues.",
    ...
    },
    {
      ...
      answer:
        "Performance can be optimized through techniques like memoization, code splitting, and lazy loading.",
      Sample:
        "Using React.lazy and Suspense for dynamic imports can enhance performance.",
    ...
    },
    {
      ...
      answer:
        "React DevTools is a browser extension that helps in debugging React applications.",
      Sample:
        "It allows inspecting the React component tree and their props and state.",
    ...
    },
    {
      ...
      Sample:
        "They are useful for modals or tooltips that need to escape overflow or fixed positioning.",
    ...
    },
    {
      ...
      answer:
        "The key attribute is used to give a unique identity to elements in a list to optimize re-rendering.",
      Sample:
        "It helps React differentiate between elements for efficient updates.",
    ...
    },
    {
      id: 52,
      Title:
        "42. What is the purpose of the shouldComponentUpdate lifecycle method?",
      answer:
        "shouldComponentUpdate determines if a component should re-render or not.",
    ...
    },
    {
      ...
      answer:
        "Routing in React can be implemented using React Router, which provides components like Route and Link.",
      Sample:
        "It allows navigation between different views in a single-page application.",
    ...
    },
    {
      ...
      Sample:
        "They provide a unique identity to each list item for efficient rendering.",
    ...
    },
    {
      ...
      answer:
        "Context allows you to share values between components without passing props through every level of the tree.",
    ...
    },
    {
      ...
      Sample:
        "It simplifies consuming context values in functional components.",
    ...
    },
    {
      ...
      answer:
        "React.lazy allows you to dynamically import components, and React.Suspense allows you to wait for these components to load.",
    ...
    },
    {
      ...
      answer:
        "Refs provide a way to access and interact with DOM elements or class component instances directly.",
      Sample:
        "They can be used for managing focus, text selection, or media playback.",
      code: `const inputRef = useRef(null);`,
    },
    {
      id: 62,
      ...
      Sample:
        "It is used for reading layout from the DOM and synchronously re-rendering.",
    ...
    },
    {
      ...
      answer:
        "Asynchronous operations can be handled using the useEffect hook or within event handlers.",
    ...
    },
    {
      ...
      answer:
        "React.Fragment is a lightweight component that allows grouping multiple elements without adding extra nodes to the DOM.",
    ...
    },
    {
      ...
      answer:
        "Code splitting is a technique that helps to split your code into smaller chunks, which can be loaded on demand.",
    ...
    },
    {
      ...
      answer:
        "useDebugValue is a hook that helps you display a label for custom hooks in React DevTools.",
    ...
    },
    {
      ...
      answer:
        "unstable_batchedUpdates allows you to batch multiple state updates into a single render for performance optimization.",
    ...
    },
    {
      ...
      answer:
        "withRouter is a higher-order component that provides the router-related props to the wrapped component.",
      Sample:
        "It is useful for accessing history, match, and location props in components.",

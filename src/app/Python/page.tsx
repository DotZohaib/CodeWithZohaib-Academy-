...
const Python: React.FC = () => {
  ...
  const array: Question[] = [
    ...
    },
    {
      ...
      answer:
        "You can handle exceptions using try-except blocks to catch and manage errors.",
    ...
    },
    {
      ...
      answer:
        "Modules are files containing Python code that can define functions, classes, and variables, allowing for code organization and reuse.",
    ...
    },
    {
      ...
      answer:
        "A class is a blueprint for creating objects that encapsulate data and functions together.",
    ...
    },
    {
      ...
      answer:
        "Inheritance is a mechanism where a new class derives from an existing class, inheriting its attributes and methods.",
    ...
    },
    {
      ...
      answer:
        "Polymorphism allows methods to do different things based on the object it is acting upon, often using method overriding.",
    ...
    },
    {
      ...
      answer:
        "You can read a file using the `open()` function in combination with the `read()` method.",
    ...
    },
    {
      ...
      answer:
        "You can write to a file using the `open()` function in write mode.",
    ...
    },
    {
      ...
      answer:
        "The `import` statement is used to include modules or packages in your Python code.",
    ...
    },
    {
      ...
      answer:
        "The `pass` statement is a null operation; it is a placeholder in blocks of code.",
    ...
    },
    {
      ...
      answer:
        "You can create a dictionary from two lists using the `zip()` function and a dictionary comprehension.",
    ...
    },
    {
      ...
      answer:
        "A decorator is a function that wraps another function, modifying its behavior without changing its source code.",
    ...
    },
    {
      ...
      answer:
        "A module is a file containing Python definitions and statements, allowing you to organize your code into reusable components.",
    ...
    },
    {
      ...
      answer:
        "`self` refers to the instance of the class in methods, allowing access to attributes and methods.",
    ...
    },
    {
      ...
      answer:
        "A regular expression is a sequence of characters that defines a search pattern, primarily used for string matching.",
    ...
    },
    {
      ...
      answer:
        "The `with` statement is used for resource management, simplifying the use of try-finally blocks.",
    ...
    },
    {
      ...
      answer:
        "A comprehension is a compact way to process elements and produce a new list or dictionary from an iterable.",
    ...
    },
    {
      ...
      answer:
        "`append()` adds a single item to the end of a list, while `extend()` adds multiple items.",
    ...
    },
    {
      ...
      answer:
        "The `__init__` method is a special method used for initializing objects in a class.",
    ...
    },
    {
      ...
      answer:
        "*args allows passing a variable number of positional arguments, while **kwargs allows passing keyword arguments.",
    ...
    },
    {
      ...
      answer:
        "The `finally` block is executed after the try and except blocks, regardless of whether an exception occurred.",
    ...
    },
    {
      ...
      answer:
        "You can create a nested function by defining a function within another function.",
    ...
    },
    {
      ...
      answer:
        "You can create a shallow copy of a list using the `copy()` method or list slicing.",
    ...
    },
    {
      ...
      answer:
        "You can filter a list using the `filter()` function, which applies a function and returns a filtered iterable.",
    ...
    },
    {
      ...
      answer:
        "`__getitem__` allows you to access items in a class using the indexing syntax.",
    ...
    },
    {
      ...
      answer:
        "Python's built-in data types include int, float, str, list, tuple, set, dict, and bool.",
    ...
    },
    {
      ...
      answer:
        "The `pass` statement is a null operation; it is syntactically required but you don't want any code to execute.",
    ...
    },
    {
      ...
      answer:
        "List comprehensions provide a concise way to create lists by iterating over an iterable.",
    ...
    },
    {
      ...
      answer:
        "Slicing is a way to access a subset of a sequence by specifying a start and end index.",
    ...
    },
    {
      ...
      answer:
        "A class method is a method that is bound to the class and not the instance, defined with `@classmethod`.",
    ...
    },
    {
      ...
      answer:
        "You can iterate over a dictionary using a for loop to access keys or items.",
    ...
    },
    {
      ...
      answer:
        "A property is a special kind of attribute that allows for encapsulation of instance variables.",
    ...
    },
    {
      ...
      answer:
        "`==` checks for value equality, while `is` checks for identity (i.e., whether two references point to the same object).",
    ...
    },
    {
      ...
      answer:
        "A list slice is a subset of a list obtained using the slicing syntax.",
    ...
    },
    {
      ...
      answer:
        "The `__init__` method is a special method used to initialize a new object.",
    ...
    },
    {
      ...
      answer:
        "The `super()` function returns a temporary object of the superclass, allowing access to its methods.",
    ...
    },
    {
      ...
      answer:
        "You create a generator using a function with the `yield` statement.",
    ...
    },
    {
      ...
      answer:
        "You can handle multiple exceptions by specifying multiple exception types in a single `except` clause.",
    ...
    },
    {
      ...
      answer:
        "A context manager is an object that defines methods `__enter__` and `__exit__` for resource management.",
      Sample: "Useful for managing resources like file streams.",
    ...
    },
    {
      ...
      answer:
        "`*args` allows you to pass a variable number of non-keyword arguments, while `**kwargs` allows for keyword arguments.",
    ...
    },
    {
      ...
      answer:
        "List unpacking allows you to assign elements of a list to variables in a single line.",
    ...
    },
    {
      ...
      answer:
        "`pop()` removes an item at a specified index and returns it, while `remove()` removes the first occurrence of a specified value.",
    ...
    },
    {
      ...
      answer:
        "Type hinting allows you to indicate the expected data types of function arguments and return values.",

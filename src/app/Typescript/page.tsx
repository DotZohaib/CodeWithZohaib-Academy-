  ...
  const array: Question[] = [
    {
      ...
      answer:
        "TypeScript is a typed superset of JavaScript that compiles to plain JavaScript, adding static typing and other features.",
      Sample:
        "It helps in catching errors during development through type-checking.",
    ...
    },
    {
      ...
      answer:
        "TypeScript provides optional static typing, interfaces, enums, and advanced tooling, improving developer productivity and code quality.",
      Sample:
        "Type annotations help to document code better and catch type-related errors early.",
    ...
    },
    {
      ...
      answer:
        "You can declare variables using 'let', 'const', or 'var', and specify types using annotations.",
      Sample:
        "Using 'let' for mutable variables and 'const' for constants helps in maintaining immutability.",
...
const name: string = "Alice";`,
    },
    {
      ...
      answer:
        "Interfaces in TypeScript define a contract for the structure of an object, allowing for better type-checking.",
      Sample:
        "They help enforce consistent object shapes across your codebase.",
...
const user: Person = { name: "Alice", age: 25 };`,
    },
    {
      ...
      answer:
        "A union type allows a variable to hold multiple types. You define it using the pipe (|) symbol.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "Enums allow you to define a set of named constants, which can be numeric or string values.",
...
let c: Color = Color.Green;`,
    },
    {
      ...
      answer:
        "A tuple is a fixed-size array with elements of different types, defined with specific type annotations.",
    ...
    },
    {
      ...
      answer:
        "Type inference is the ability of TypeScript to automatically deduce types based on variable assignments.",
      Sample:
        "This allows developers to omit type annotations when the types can be inferred.",
    ...
    },
    {
      ...
      answer:
        "Functions can be declared with type annotations for parameters and return types.",
      Sample:
        "This ensures that the function is called with the correct types.",
    ...
    },
    {
      ...
      answer:
        "The 'any' type allows a variable to hold any type of value, disabling type checking.",
      Sample:
        "It should be used sparingly, as it defeats the purpose of TypeScript.",
...
anything = 5;`,
    ...
    },
    {
      ...
      answer:
        "You handle exceptions using try-catch blocks, just like in JavaScript.",
    ...
    },
    {
      ...
      answer:
        "Both 'interface' and 'type' can be used to define object shapes, but interfaces can be merged, while types cannot.",
...
type Admin = User & { isAdmin: boolean };`,
    },
    {
      ...
      answer:
        "Classes can be created using the 'class' keyword, and you can specify types for properties and methods.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "Access modifiers control the visibility of class members. They are public, private, and protected.",
    ...
    },
    {
      ...
      answer:
        "TypeScript allows you to specify the type of variables within a 'for' loop.",
    ...
    },
    {
      ...
      answer:
        "'forEach' can have typed callback parameters in TypeScript for type-safe iteration.",
  ...
  numbers.forEach((num: number) => {
    ...
    },
    {
      ...
      answer:
        "TypeScript's type system allows complex 'if-else' conditions with type-safe variables.",
      Sample:
        "Use 'if-else' to handle conditions with multiple type-safe variables.",
  ...
  if (isAdult) {
    ...
    },
    {
      ...
      answer:
        "'map' creates a new array by applying a function to each element, unlike 'forEach', which only iterates.",
...
class Circle implements Drawable {
    ...
    },
    {
      ...
      answer:
        "The 'never' type represents values that never occur, such as a function that always throws an error.",
    ...
    },
    {
      ...
      answer:
        "Namespaces are a way to group related code and avoid naming collisions.",
    ...
    },
    {
      ...
      answer:
        "Type assertions allow you to override TypeScript's inferred type, asserting a specific type instead.",
      Sample:
        "This can be useful when you are certain about the type of a value.",
...
let strLength: number = (value as string).length;`,
    },
    {
      ...
      answer:
        "Type guards allow you to narrow down types in conditional statements.",
    ...
    },
    {
      ...
      answer:
        "The 'readonly' modifier makes properties immutable, preventing them from being changed.",
    ...
    },
    {
      ...
      answer:
        "You can create a union of interfaces to define a variable that can be one of several types.",
...
function speak(animal: Dog | Cat) {
    ...
    },
    {
      ...
      answer:
        "The 'keyof' operator creates a union of string literal types representing the keys of an object.",
      Sample:
        "This allows for better type safety when accessing object properties.",
      code: `interface Person {
    name: string;
    age: number;
}
...
type PersonKeys = keyof Person; // "name" | "age"`,
    },
    {
      ...
      answer:
        "Conditional types allow for defining types based on a condition, using the 'extends' keyword.",
    ...
    },
    {
      ...
      Sample:
        "They simplify function calls when default values are sufficient.",
    ...
    },
    {
      ...
      answer:
        "You can declare overloaded functions by defining multiple function signatures.",
      Sample:
        "The implementation can be a single function that handles all cases.",
...
function combine(a: any, b: any): any {
    ...
    },
    {
      ...
      answer:
        "'this' type refers to the type of the current context within a function.",
    ...
    },
    {
      ...
      answer:
        "Promises in TypeScript are similar to JavaScript, but you can specify types for resolved and rejected values.",
    ...
    },
    {
      ...
      answer:
        "'async' and 'await' are used for writing asynchronous code in a more readable way.",
    ...
    },
    {
      ...
      answer:
        "Namespaces are defined using the 'namespace' keyword and can encapsulate related code.",
    ...
    },
    {
      ...
      answer:
        "The 'import' keyword is used to bring in variables, functions, or classes from other modules.",
    ...
    },
    {
      ...
      answer:
        "Callable types define the type of a function, specifying its parameters and return type.",
    ...
    },
    {
      ...
      answer:
        "The 'override' modifier ensures that a method in a derived class overrides a method in its base class.",
...
class Derived extends Base {
    ...
    },
    {
      ...
      answer:
        "The 'infer' keyword is used in conditional types to infer types within the true branch.",
    ...
    },
    {
      ...
      answer:
        "Decorators are a special kind of declaration that can be attached to a class or method to modify its behavior.",
...
class Example {
    ...
    },
    {
      ...
      answer:
        "The 'void' type represents the absence of a value, typically used as a return type for functions that do not return anything.",
    ...
    },
    {
      ...
      answer:
        "You can create private members in a class using the 'private' access modifier.",

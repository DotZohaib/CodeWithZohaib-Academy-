  ...
  const array: Question[] = [
    {
      ...
      Title: "1. What is PHP?",
      answer:
        "PHP is a server-side scripting language designed for web development, but it is also used as a general-purpose programming language.",
    ...
    },
    {
      ...
      answer:
        "Variables in PHP are prefixed with a dollar symbol ($) and do not need explicit type declarations.",
      Sample: "$name = 'John';",
      code: `<?php $name = 'John'; ?>`,
    },
    {
      ...
      answer:
        "PHP supports several data types, including Integer, Float, String, Boolean, Array, Object, NULL, and Resource.",
    ...
    },
    {
      ...
      answer:
        "Arrays in PHP can be created using the array() function or square brackets [].",
    ...
    },
    {
      ...
      answer:
        "A function is a block of statements that can be reused and executed when called. PHP has built-in functions and allows users to create custom functions.",
    ...
    },
    {
      ...
      answer:
        "A class is a blueprint for creating objects and encapsulates properties and methods.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "PHP provides error-handling functions like try-catch blocks and error reporting functions.",
      Sample:
        "try { // code } catch (Exception $e) { echo 'Caught exception: ',  $e->getMessage(), '\\n'; }",
    ...
    },
    {
      ...
      answer:
        "PHP includes files using include, include_once, require, and require_once statements.",
    ...
    },
    {
      ...
      answer:
        "If an included file is not found, include() generates a warning, while require() throws a fatal error.",
    ...
    },
    {
      ...
      answer:
        "A session in PHP is started using session_start() and allows you to store user data across pages.",
    ...
    },
    {
      ...
      answer:
        "Cookies store user data on the client side and can be set using setcookie().",
    ...
    },
    {
      ...
      answer:
        "Superglobals are predefined global arrays, such as $_GET, $_POST, $_SESSION, $_COOKIE, that are accessible from any scope.",
    ...
    },
    {
      ...
      answer:
        "password_hash() and password_verify() are used to securely hash and verify passwords.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "PDO (PHP Data Objects) is a database access layer providing a uniform method to access multiple databases securely.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "Default parameters allow you to set a default value for a function argument if it is not provided.",
    ...
    },
    {
      ...
      answer:
        "A closure is an anonymous function that can be stored in a variable and passed as an argument.",
    ...
    },
    {
      ...
      answer:
        "Type hinting ensures that parameters passed to functions are of a specified type.",
    ...
    },
    {
      ...
      answer:
        "Type hinting allows you to specify the expected data type of arguments to functions, helping to catch type errors earlier in the code execution.",
      Sample: "function add(int $a, int $b): int { return $a + $b; }",
      code: `<?php function add(int $a, int $b): int { return $a + $b; } ?>`,
    },
    {
      ...
      answer:
        "Both echo and print output data to the screen. echo can take multiple parameters and is slightly faster, while print returns a value and can only take one argument.",
    ...
    },
    {
      ...
      answer:
        "Constants are defined using the define() function or const keyword, and their values cannot be changed after declaration.",
    ...
    },
    {
      ...
      answer:
        "Constructors initialize an object when it's created, while destructors are invoked when an object is destroyed. They are defined as __construct() and __destruct() respectively.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "Inheritance allows a class to use the properties and methods of another class, using the 'extends' keyword.",
    ...
    },
    {
      ...
      answer:
        "Interfaces define methods that implementing classes must contain, ensuring a class adheres to a specific structure.",
      Sample:
        "interface Logger { public function log($message); } class FileLogger implements Logger { public function log($message) { echo $message; } }",
    ...
    },
    {
      ...
      answer:
        "Polymorphism allows objects of different types to be treated as objects of a common super type, typically through inheritance and interfaces.",
    ...
    },
    {
      ...
      answer:
        "Abstract classes provide a base class with abstract methods that must be implemented by subclasses. They cannot be instantiated directly.",
      Sample:
    ...
    },
    {
      ...
      Sample:
        "class Animal { public function sound() { echo 'Sound'; } } class Dog extends Animal { public function sound() { echo 'Bark'; } }",
    ...
    },
    {
      ...
      answer:
        "PHP provides try-catch blocks for exception handling, where exceptions are thrown using the throw keyword.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "A static method belongs to the class rather than instances of the class. It can be called without creating an object of the class.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "GET appends data to the URL and is used for retrieving data, while POST sends data within the request body and is used for submitting data.",
    ...
    },
    {
      ...
      answer:
        "MVC (Model-View-Controller) is a design pattern that separates the application logic, user interface, and input into three interconnected components.",
    ...
    },
    {
      ...
      answer:
        "Prepared statements in PHP help prevent SQL injection by separating SQL logic from data values.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "Public properties can be accessed from anywhere, protected properties are accessible within the class and its subclasses, and private properties are accessible only within the class.",
    ...
    },
    {
      ...
      answer:
        "PHP handles file uploads through the $_FILES superglobal, which stores information about uploaded files.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "An interface is defined using the interface keyword, and implementing classes must define its methods.",
    ...
    },
    {
      ...
      answer:
        "Composer manages packages and libraries for PHP projects, allowing for easier dependency management.",
    ...
    },
    {
      ...
      answer:
        "The if-else statement executes one block of code if a specified condition is true, otherwise it executes another block of code.",
    ...
    },
    {
      ...
      answer:
        "The elseif statement allows multiple conditions to be evaluated in a sequence if previous conditions are false.",
      Sample:
        "if ($score >= 90) { echo 'A'; } elseif ($score >= 80) { echo 'B'; } else { echo 'C'; }",
    ...
    },
    {
      ...
      answer:
        "The switch statement is used to perform different actions based on multiple possible values of a single variable.",
      Sample:
        "switch ($color) { case 'red': echo 'Red'; break; case 'blue': echo 'Blue'; break; default: echo 'Other'; }",
    ...
    },
    {
      ...
      answer:
        "The foreach loop is used to iterate over arrays and access each value in the array without needing an index.",
    ...
    },
    {
      ...
      answer:
        "The do-while loop executes a block of code once and then repeats it as long as the specified condition is true.",
    ...
    },
    {
      ...
      answer:
        "PHP allows nesting of loops, meaning you can use one loop inside another loop. Each loop should have its own loop variable to avoid conflicts.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "Namespaces in PHP allow you to group related classes, functions, and constants, avoiding naming conflicts.",
    ...
    },
    {
      ...
      answer:
        "Traits are a mechanism for code reuse in PHP, allowing you to include methods in multiple classes without inheritance.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "A closure is an anonymous function that can be stored in a variable and passed as an argument to other functions.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "Sessions in PHP are started with session_start(), allowing you to store user data across pages.",
    ...
    },
    {
      ...
      answer:
        "PHP handles file uploads via the $_FILES array, where you can validate and move uploaded files to a server directory.",
      Sample:
        "move_uploaded_file($_FILES['file']['tmp_name'], 'uploads/' . $_FILES['file']['name']);",
      code: `<?php move_uploaded_file($_FILES['file']['tmp_name'], 'uploads/' . $_FILES['file']['name']); ?>`,
    },
    {
      ...
      answer:
        "Composer is a dependency manager for PHP that allows you to manage libraries and packages for your project.",
      Sample: "composer require vendor/package",
      code: `# Run in terminal
    composer require vendor/package`,
    },
    {
      ...
      answer:
        "PHP has json_encode() and json_decode() functions to handle JSON data.",
      Sample:
        "$json = json_encode(['name' => 'Alice']); $array = json_decode($json, true);",
    ...
    },
    {
      ...
      answer:
        "REST API integration involves sending HTTP requests to REST endpoints. PHP can handle REST APIs with cURL or file_get_contents().",

  ...
  const array = [
    {
      ...
      Sample:
        "CSS defines how HTML elements should be displayed, making webpages visually appealing.",
      code: `body {
    ...
    },
    {
      ...
      answer:
        "CSS selectors are patterns used to select elements for styling based on their tags, classes, IDs, or attributes.",
      Sample:
        "Selectors help apply styles to HTML elements using classes, IDs, or element names.",
      code: `.my-class {
    color: blue;
}
#my-id {
    ...
    },
    {
      ...
      answer:
        "CSS comments are added with `/* comment */` and are ignored by the browser.",
      Sample:
        "Use comments to leave notes or explanations within your CSS code.",
...
body {
    ...
    },
    {
      ...
      answer:
        "The box model describes the layout of elements using margin, border, padding, and content.",
      Sample:
        "Each HTML element can be visualized as boxes with different layers for spacing and styling.",
      code: `div {
    margin: 10px;
    padding: 15px;
    ...
    },
    {
      ...
      answer:
        "To center an element, you can use margin auto for block elements or flexbox/grid for more control.",
...
.flex-container {
    ...
    },
    {
      ...
      answer:
        "Flexbox is a layout model that makes it easier to design a flexible, responsive layout structure without using float or positioning.",
      Sample:
        "Flexbox is used to create layouts that are easy to align, reorder, and distribute within a container.",
      code: `.flex-container {
    display: flex;
    flex-direction: row;
    ...
    },
    {
      ...
      answer:
        "CSS Grid Layout is a two-dimensional layout system for web pages, allowing you to position elements in rows and columns.",
    ...
    },
    {
      ...
      Sample:
        "Padding controls spacing within the element's border, while margin affects spacing around the element.",
      code: `div {
    padding: 20px;
    margin: 10px;
}`,
    },
    {
      ...
      answer:
        "Use the `background-image` property with a URL to set a background image.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "CSS animations allow you to animate the transition between CSS property states.",
      Sample:
        "CSS animations can make elements move, change color, or scale in response to actions.",
...
div:hover {
    ...
    },
    {
      ...
      answer:
        "A CSS preprocessor extends CSS with variables, nesting, and functions, making it more maintainable.",
...
.button {
    ...
    },
    {
      ...
      answer:
        "Use media queries to apply different styles for various screen sizes.",
    ...
    },
    {
      ...
      answer:
        "Responsive design is an approach that ensures web pages look good on all devices by using flexible layouts, images, and CSS media queries.",
      Sample:
        "Responsive design adjusts layouts based on the device's screen size.",
      code: `body {
    display: flex;
    flex-wrap: wrap;
}`,
    },
    {
      ...
      Sample:
        "You can include fonts from various sources, including Google Fonts.",
      code: `@font-face {
...
.box2 {
    ...
    },
    {
      ...
      answer:
        "The `display` property specifies the display behavior of an element, such as block, inline, flex, or grid.",
    ...
    },
    {
      ...
      answer:
        "Define a grid container and set its columns and rows with the `grid-template-columns` and `grid-template-rows` properties.",
    ...
    },
    {
      ...
      answer:
        "Use the `position: sticky` property to make a header stick to the top of the viewport as you scroll.",
...
button {
    ...
    },
    {
      ...
      answer:
        "Define button styles using padding, background, border, and hover effects.",
...
button:hover {
    ...
    },
    {
      ...
      answer:
        "`rem` and `em` are relative units for font sizes and spacing. `em` is relative to the parent element, while `rem` is relative to the root element.",
...
p {
    ...
    },
    {
      ...
      answer:
        "You can create a transition effect by using the `transition` property on an element.",
      Sample:
        "Transitions help create smooth visual changes on user interaction.",
      code: `div {
...
div:hover {
    ...
    },
    {
      ...
      answer:
        "Media queries are a feature of CSS that allows content rendering to adapt to different conditions such as screen size.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "Use the `box-shadow` property to create shadow effects on elements.",
    ...
    },
    {
      ...
      Sample:
        "Use transitions for smooth changes when an element's state changes.",
      code: `button {
...
button:hover {
    ...
    },
    {
      ...
      answer:
        "Use the `cursor` property to specify the type of cursor to be displayed when pointing over an element.",
    ...
    },
    {
      ...
      answer:
        "`relative` positioning positions an element relative to its normal position, while `absolute` positioning positions an element relative to its closest positioned ancestor.",
...
.absolute {
    ...
    },
    {
      ...
      answer:
        "Set the border-radius property to 50% for a square element to create a circle.",
    ...
    },
    {
      ...
      answer:
        "Use nested lists and CSS to hide/show the dropdown items on hover.",
...
ul li:hover .dropdown {
    ...
    },
    {
      ...
      answer:
        "The `clip-path` property allows you to create complex shapes by clipping an element to a specified path.",
    ...
    },
    {
      ...
      answer:
        "The `transform` property applies 2D or 3D transformations to elements, such as rotate, scale, skew, or translate.",
...
@keyframes spin {
    ...
    },
    {
      ...
      answer:
        "CSS frameworks are pre-prepared libraries that are meant to be used as a base for starting a project.",
      Sample:
        "Popular CSS frameworks include Bootstrap, Tailwind CSS, and Foundation.",
...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">`,
    ...
    },
    {
      ...
      answer:
        "The `float` property allows elements to float to the left or right of their container, allowing text and inline elements to wrap around them.",
    ...
    },
    {
      ...
      answer:
        "To create a full-width layout, set the width of the element to 100% and remove any padding and margin.",
    ...
    },
    {
      ...
      answer:
        "CSS sprites are a technique to optimize web performance by combining multiple images into a single image.",
...
.sprite2 { background-position: -50px 0; }`,
    ...
    },
    {
      ...
      answer:
        "A CSS framework is a pre-prepared library that provides a base for styling web applications.",
...
<link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">`,
    },
    {
      ...
      answer:
        "Transitions are a way to create smooth changes in CSS property values over a specified duration.",
      Sample:
        "Transitions can improve user experience by creating a smoother visual effect.",
      code: `div {
    ...
    },
    {
      ...
      answer:
        "The `align-items` property defines the default behavior for how flex items are laid out along the cross axis.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "You can create a grid layout by setting display: grid on a container element and defining rows and columns.",
    ...
    },
    {
      ...
      answer:
        "The `justify-content` property defines how flex items are aligned along the main axis.",
      Sample:
    ...
    },
    {
      ...
      answer:
        "The `gap` property is used to set the spacing between grid items.",
      Sample:
        "This property simplifies the spacing management in grid layouts.",
      code: `.grid-container {
    display: grid;
    ...
    },
    {
      ...
      answer:
        "The `object-fit` property specifies how the content of a replaced element (like images) should be resized to fit its container.",
    ...
    },
    {
      ...
      answer:
        "The `position: sticky` property allows an element to stick to a specific position while scrolling.",
    ...
    },
    {
      ...
      answer:
        "Tooltips can be created using the `::after` pseudo-element and absolute positioning.",
...
.tooltip::after {
    ...
    },
    {
      id: 58,
      Title:
        "58. How do you implement a media query for landscape orientation?",
      answer:
        "Use media queries to apply styles based on the device's orientation.",
...
div:hover {
    ...
    },
    {
      ...
      answer:
        "Use the `:hover` pseudo-class to change the text color when the mouse hovers over an element.",
    ...
    },
    {
      ...
      answer:
        "To create a sticky footer, use `position: sticky` or set the footer at the bottom of the viewport.",
    ...
    },
    {
      ...
      answer:
        "To transition height, you must set an explicit height on the element.",
...
div:hover {
    ...
    },
    {
      ...
      answer:
        "CSS animations allow you to animate transitions between CSS styles over time.",
...
div {
    ...
    },
    {
      ...
      answer:
        "CSS fallbacks are used to provide alternative styles if the primary styles are not supported.",
    ...
    },
    {
      ...
      answer:
        "Define a grid layout using `grid-template-areas` for a named grid layout.",
    ...
    },
    {
      ...
      answer:
        "You can implement a CSS framework by including it in your project, usually through a CDN or by downloading the files.",
    ...
    },
    {
      ...
      answer:
        "The `align-content` property defines how flex lines are aligned in the flex container.",
      Sample:

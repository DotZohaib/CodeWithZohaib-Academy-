...
const Chatbot = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col items-end">
      {/* Chat Window */}
      {isOpen && (
        <div className="mb-4 w-[330px] h-[520px] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-slideUp">
          {/* Header */}
          ...
          <div className="flex-1 overflow-y-auto w-full p-4 bg-gray-50">
            {showNameInput ? (
              <div className="flex flex-col items-center justify-center h-full gap-4 w-full  ">
                ...
                <p className="text-gray-600 text-center">Please enter your name</p>
                <div className="w-full max-w-sm flex flex-col items-center justify-center gap-2">
                  <input
                    type="text"
                    value={userInput}

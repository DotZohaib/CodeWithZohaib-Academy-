    ...
    <footer className="text-gray-600 bg-white body-font dark:bg-gray-800 dark:text-white">
      <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
        ...
        <div className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start" style={{ alignItems: 'center' }}>
          <Link href="https://www.facebook.com/codewithCodeWithZohaib" aria-label="facebook" target="_blank" rel="noreferrer" className="text-gray-500 dark:text-gray-300">
          ...
          <Link href="https://www.instagram.com/codewithCodeWithZohaib" aria-label="instagram" target="_blank" rel="noreferrer" className="ml-3 text-gray-500 dark:text-gray-300">
            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
              <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
              <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
            </svg>
          </Link>
          <Link href="https://www.github.com/codewithCodeWithZohaib" aria-label="github" target="_blank" rel="noreferrer" className="ml-3 text-gray-500 dark:text-gray-300">
